	...
	return (
		<div className="min-h-screen bg-neutral-950 w-[75vw] border-r-2 border-neutral-800">
			...
			<p className="text-neutral-400 max-w-[90%] mx-auto mb-6">
				...
				corrupti quia animi non, hic dicta voluptatum doloribus ut perspiciatis.
				Nesciunt, quaerat assumenda eum culpa amet nam perspiciatis, id tempora
				atque voluptates voluptate? Atque nulla possimus sunt voluptate. Ex,
				repellendus corrupti. Lorem ipsum dolor sit amet consectetur adipisicing
				elit. Odit, obcaecati.
			</p>
			<p className="text-neutral-400 max-w-[90%] mx-auto mb-6">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti
				...
				atque voluptates voluptate? Atque nulla possimus sunt voluptate. Ex,
				repellendus corrupti. Lorem ipsum dolor sit amet consectetur adipisicing
				elit. Harum, laboriosam? Lorem ipsum dolor, sit amet consectetur
				adipisicing elit. Ut numquam debitis ullam corporis, quos rerum, magni
				odio explicabo voluptates totam dolor expedita laborum perferendis quas
				nihil fugit enim, eum reprehenderit!
			</p>
			<p className="text-neutral-400 max-w-[90%] mx-auto mb-6">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti
				corrupti quia animi non, hic dicta voluptatum doloribus ut perspiciatis.
			...
			<div className="flex w-[90%] mx-auto my-16 items-center justify-center">
